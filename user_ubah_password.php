...
<table width="100%">
  ...
  <tr>
    <td width="18%" valign="top">Username</td>
...
if( isset($_POST['tombol'])) {
   if(($_SESSION['security_code'] == $_POST['security_code']) && (!empty($_SESSION['security_code'])) ) {
	...
	if ($cek>0){
	   ...
	   echo "<meta http-equiv=\"refresh\" content=\"0; url=user_index.php?page=10&current10=curren&act=berhasil&u=$username\">";
	}else{
	echo  "<meta http-equiv=\"refresh\" content=\"0; url=user_index.php?page=10&current10=curren&act=gagal&u=$username\">";
	}
	
	
	}else{
	echo "<meta http-equiv=\"refresh\" content=\"0; url=user_index.php?page=10&current10=curren&act=gagal2&u=$username\">";
	}
}
