...
<br/>
<div class="title">Form Registrasi User </div>
...
<tr>
  ...
  <tr>
    ...
    <td valign="bottom" ><span id="sprytextfield7">
	  ...
	  <br>
	  <span class="style2">Panjang minimal 5 karakter.</span></td>
  </tr>
    <tr>
    ...
    <td valign="bottom"><span id="sprypassword">
	  ...
	  <br>
	  <span class="style2">Panjang minimal 6 karakter.</span>	  </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    <td valign="bottom">
	<span id="validsel"><span id="validsel">
	<select name="usia">
	...
	</span><span class="selectRequiredMsg"><img src="images/cancel_f2.png"width="10" height="10"> Usia Anak harus dipilih.</span></span>    </td>
  </tr>
  <tr>
    <td>Jenis Kelamin</td>
    <td>:</td>
  ...
  <tr>
    <td height="40" colspan="3" align="right" valign="bottom"><input type="submit" name="tombol" value="Daftar" /><input type="reset" name="reset" value="Hapus" />	</td>
    </tr>
</table>
</form>
